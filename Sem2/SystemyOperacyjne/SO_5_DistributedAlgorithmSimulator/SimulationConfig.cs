...
namespace SO_5_DistributedAlgorithmSimulator
{
	class SimulationConfig
	{
		...
		public readonly int averageTimeBetweenNewTask = 1;      // 3 time units average between new task is added
		public readonly int amtOfProcesses = 10000;

		public readonly int minProcessSize = 100;
		public readonly int maxProcessSize = 1000; // assuming that process sized 100 can be computed in one cycle if use 100% load
